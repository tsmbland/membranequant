...
# Input data
conds_list_total = [
    '180622_jh1799_48hrpkc_tom3,15',
    '180622_jh1799_wt_tom3,15',
    '180622_jh2817_48hrpkc_tom3,15',
    '180622_jh2817_wt_tom3,15',
    '180622_kk1273_48hrpkc_tom3,15',
    '180622_kk1273_wt_tom3,15',
    '180622_th129_48hrpkc_tom3,15',
    '180622_th129_wt_tom3,15']
...
kk1273_wt = batch_import(adirec, np.array(conds_list_total)[[5]], Res)
kk1273_pkc = batch_import(adirec, np.array(conds_list_total)[[4]], Res)
jh1799_wt = batch_import(adirec, np.array(conds_list_total)[[1]], Res)
jh1799_pkc = batch_import(adirec, np.array(conds_list_total)[[0]], Res)
jh2817_wt = batch_import(adirec, np.array(conds_list_total)[[3]], Res)
jh2817_pkc = batch_import(adirec, np.array(conds_list_total)[[2]], Res)
th129_wt = batch_import(adirec, np.array(conds_list_total)[[7]], Res)
th129_pkc = batch_import(adirec, np.array(conds_list_total)[[6]], Res)
