...
# Input data
conds_list_total = ['180316_nwg0129_par3_tom3,15,pfsout',
                    '180316_kk1228_wt_tom3,15,pfsout']
...
nwg0129_wt = batch_import(adirec, np.array(conds_list_total)[[0]], Res)
kk1228_wt = batch_import(adirec, np.array(conds_list_total)[[1]], Res)
