...
conds_list_total = ['PKC_rundown_Florent_MP/180301/180301_NWG91_25PKC',
                    'PKC_rundown_Florent_MP/180301/180301_NWG91_50PKC',
                    'PKC_rundown_Florent_MP/180301/180301_NWG91_75PKC']
...
def func1(embryo):
    data = d(embryo)
    try:
        coors = fit_coordinates_alg3(composite(data, settings, 0.2), data.ROI_orig, bgcurve, 2, mag=5/3)
...
nwg91_rd = Results(np.array(conds_list_total)[[0, 1, 2]])
